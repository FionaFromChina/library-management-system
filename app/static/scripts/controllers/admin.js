...
adminApp.controller('navCtrl', ['$scope', '$http', '$location',
    function($scope, $http, $location) {
        ...
        var navGroups = [{
            ...
            navName: '添加读者类别',
            urlName: 'addReaderType'
        },{
            navName: '管理读者类别',
            urlName: 'seeAllReaderType'
        }];
...
//添加读者类别
adminApp.controller('addReaderType', ['$scope', '$http',
    function($scope, $http) {
        //检验通过
...
//查看全部读者类别
adminApp.controller('seeAllReaderType', ['$scope', '$http',
    function($scope, $http) {
        $scope.filterOptions = {
            filterText: "",
